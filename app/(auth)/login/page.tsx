...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("manujendragaurav@gmail.com");
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center px-6 py-12 relative">
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[300px] bg-blue-600/10 blur-[100px] rounded-full pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-slate-400 text-xs text-center mb-6">
            Sign in with your email or social OAuth provider to access your pipeline.
          </p>
